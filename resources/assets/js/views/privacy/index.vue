                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="">
                                    <a href="#spanish" aria-controls="spanish" role="tab" data-toggle="tab"
                                        aria-expanded="false"> Spanish</a>
                                </li>
                                <li role="presentation" class="">
                                    <a href="#french" aria-controls="french" role="tab" data-toggle="tab" aria-expanded="true">
                                        French</a>
                                </li>
                                <li role="presentation">
                                    <a href="#german" aria-controls="german" role="tab" data-toggle="tab"> German</a>
                                </li>
                                <li role="presentation">
                                    <a href="#italian" aria-controls="italian" role="tab" data-toggle="tab"> Italian</a>
                                </li>
                                <li role="presentation">
                                    <a href="#dutch" aria-controls="dutch" role="tab" data-toggle="tab"> Dutch</a>
                                </li>
                            </ul>
                                ...
                                <div class="page-tabs">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane" id="english">
                                            ...
                                            <p>Training and Placement Cell, GNDEC ("us", "we", or "our") operates the
                                            ...
                                            <p>This page informs you of our policies regarding the collection, use, and
                                                ...
                                                Placement Cell, GNDEC is managed through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free
                                                    Privacy Policy</a>.</p>
                                            ...
                                            <p>This Usage Data may include information such as your computer's Internet
                                                ...
                                                diagnostic data.</p>
                                            <p>When you access the Service by or through a mobile device, this Usage
                                            ...
                                            <p>We use cookies and similar tracking technologies to track the activity
                                                on our Service and hold certain information.</p>
                                            ...
                                            <p>You can instruct your browser to refuse all cookies or to indicate when
                                                a cookie is being sent. However, if you do not accept cookies, you may
                                                not be able to use some portions of our Service.</p>
                                            <p>Examples of Cookies we use:</p>
                                            <ul>
                                                <li><strong>Session Cookies.</strong> We use Session Cookies to operate
                                                    our Service.</li>
                                                <li><strong>Preference Cookies.</strong> We use Preference Cookies to
                                                    remember your preferences and various settings.</li>
                                                <li><strong>Security Cookies.</strong> We use Security Cookies for
                                                    security purposes.</li>
                                            </ul>

                                            <h2>Use of Data</h2>

                                            <p>Training and Placement Cell, GNDEC uses the collected data for various
                                                purposes:</p>
                                            <ul>
                                            ...
                                            <p>If you are located outside India and choose to provide information to
                                                us, please note that we transfer the data, including Personal Data, to
                                                India and process it there.</p>
                                            ...
                                            <p>Training and Placement Cell, GNDEC will take all steps reasonably
                                            ...
                                            <p>Training and Placement Cell, GNDEC may disclose your Personal Data in
                                                the good faith belief that such action is necessary to:</p>
                                            <ul>
                                                <li>To comply with a legal obligation</li>
                                                <li>To protect and defend the rights or property of Training and
                                                    Placement Cell, GNDEC</li>
                                                <li>To prevent or investigate possible wrongdoing in connection with
                                                    the Service</li>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <p>For more information on the privacy practices of Google, please
                                                        visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                                                </li>
                                            </ul>
                                            ...
                                            <ul>
                                                <li>By email: gndectpo@gmail.com</li>
                                                <li>By visiting this page on our website:
                                                    https://www.tnpgndec.com/privacy</li>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="spanish">
                                            ...
                                            <p>Fecha efectiva: October 03, 2018</p>


                                            <p>Training and Placement Cell, GNDEC ("nosotros", "a nosotros", "nuestro")
                                                opera el sitio web https://www.tnpgndec.com/ y la aplicación móvil
                                                Training And Placement Cell (en adelante, el "Servicio").</p>

                                            <p>Esta página le informa de nuestras políticas en materia de recopilación,
                                                uso y divulgación de datos personales cuando utiliza nuestro Servicio y
                                                de las opciones de las que dispone en relación con esos datos. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Política
                                                    de privacidad via Free Privacy Policy</a>.</p>

                                            <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar
                                                ...
                                                significados que nuestros Términos y Condiciones.</p>

                                            <h2>Definiciones</h2>
                                            <ul>
                                                <li>
                                                    <p><strong>Servicio</strong></p>
                                                    <p>Servicio significa el sitio web https://www.tnpgndec.com/ y la
                                                        aplicación móvil Training And Placement Cell operados por
                                                        Training and Placement Cell, GNDEC</p>
                                                </li>
                                                <li>
                                                    <p><strong>Datos personales</strong></p>
                                                    <p>Datos personales significa los datos sobre una persona física
                                                ...
                                                <li>
                                                    ...
                                                    <p>Datos de uso son los datos recopilados automáticamente,
                                                        ...
                                                        visita a una página).</p>
                                                </li>
                                                <li>
                                                    <p><strong>Cookies</strong></p>
                                                    <p>Las cookies son pequeños archivos ialmacenados en su dispositivo
                                                        (ordenador o dispositivo móvil).</p>
                                                </li>
                                            </ul>

                                            <h2>Recopilación y uso de la información</h2>
                                            <p>Recopilamos diferentes tipos de información con diversas finalidades
                                                para prestarle el
                                            ...
                                            <p>Cuando utilice nuestro Servicio, es posible que le pidamos que nos
                                                ...
                                                incluir, entre otras, la siguiente:</p>
                                            ...
                                            <p>También podemos recopilar información que envía su dispositivo siempre
                                                que visita nuestro Servicio o cuando usted accede al Servicio a través
                                                de un dispositivo móvil ("Datos de uso").</p>
                                            <p>Estos Datos de uso pueden incluir información como la dirección del
                                                ...
                                                diagnóstico.</p>
                                            <p>Cuando accede al Servicio econ un dispositivo móvil, estos Datos de uso
                                            ...
                                            <p>Utilizamos cookies y tecnologías de seguimiento similares para rastrear
                                                la actividad de nuestro Servicio y mantener determinada información.</p>
                                            <p>Las cookies son archivos con una pequeña cantidad de datos que pueden
                                                ...
                                                y analizar nuestro Servicio.</p>
                                            <p>Usted puede ordenar a su navegador que rechace todas las cookies o que
                                                le avise cuando se envía una cookie. Sin embargo, si no acepta cookies,
                                                es posible que no pueda utilizar algunas partes de nuestro Servicio.</p>
                                            <p>Ejemplos de Cookies que utilizamos:</p>
                                            <ul>
                                                <li><strong>Cookies de sesión.</strong> Utilizamos Cookies de sesión
                                                    para operar nuestro Servicio.</li>
                                                <li><strong>Cookies de preferencia.</strong> Utilizamos Cookies de
                                                    preferencia para recordar sus preferencias y diversos ajustes.</li>
                                                <li><strong>Cookies de seguridad.</strong> Utilizamos Cookies de
                                                    seguridad para fines de seguridad.</li>
                                            </ul>

                                            <h2>Uso de datos</h2>
                                            <p>Training and Placement Cell, GNDEC utiliza los datos recopilados con
                                                diversas finalidades:</p>
                                            <ul>
                                                <li>Suministrar y mantener nuestro Servicio</li>
                                                <li>Notificarle cambios en nuestro Servicio</li>
                                                <li>Permitirle participar en funciones interactivas de nuestro Servicio
                                                    cuando decida hacerlo</li>
                                                <li>Prestar asistencia al cliente</li>
                                                <li>Recopilar análisis o información valiosa que nos permitan mejorar
                                                    nuestro Servicio</li>
                                            ...
                                            <p>Su información, incluyendo Datos personales, puede ser transferida a —y
                                                ...
                                                datos pueden diferir de las de su jurisdicción.</p>
                                            <p>Si usted se encuentra fuera de India y decide facilitarnos información,
                                                tenga en cuenta que nosotros transferimos los datos, incluyendo Datos
                                                personales, a India y que los tratamos allí.</p>
                                            <p>Su aceptación de esta Política de privacidad seguida de su envío de esta
                                                información representa que está de acuerdo con dicha transferencia.</p>
                                            <p>Training and Placement Cell, GNDEC emprenderá todas las medidas
                                            ...
                                            <p>Training and Placement Cell, GNDEC puede divulgar sus Datos personales
                                                de buena fe cuando considere que esta acción es necesaria para lo
                                                siguiente:</p>
                                            <ul>
                                                <li>Cumplir una obligación legal</li>
                                                <li>Proteger y defender los derechos o bienes de Training and Placement
                                                    Cell, GNDEC</li>
                                                <li>Prevenir o investigar posibles infracciones en relación con el
                                                    Servicio</li>
                                                <li>Proteger la seguridad personal de usuarios del Servicio o del
                                                    público</li>
                                                <li>Protegerse frente a consecuencias legales</li>
                                            </ul>

                                            <h2>Seguridad de los datos</h2>
                                            <p>La seguridad de sus datos es importante para nosotros, pero recuerde que
                                            ...
                                            <p>Podemos contratar a personas físicas y jurídicas terceras para facilitar
                                                ...
                                                nuestro Servicio.</p>
                                            <p>Estos terceros tienen acceso a sus Datos personales únicamente para
                                                realizar estas tareas en nuestro nombre y están obligados a no
                                                divulgarlos ni utilizarlos con ningún otro fin.</p>

                                            <h3>Análisis</h3>
                                            <p>Podemos utilizar Proveedores de servicios terceros para controlar y
                                                analizar el uso de nuestro Servicio.</p>
                                            <ul>
                                                <li>
                                                    <p><strong>Google Analytics</strong></p>
                                                    <p>Google Analytics es un servicio de analítica web ofrecido por
                                                        ...
                                                        su propia red de publicidad.</p>
                                                    <p>Para más información sobre las prácticas de privacidad de
                                                        Google, visite la página web de Privacidad y Condiciones de
                                                        Google: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                                                </li>
                                            </ul>


                                            <h2>Enlaces a otros sitios</h2>
                                            <p>Nuestro Servicio puede contener enlaces a otros sitios no operados por
                                                ...
                                                Política de privacidad de todos los sitios que visite.</p>
                                            <p>No tenemos ningún control ni asumimos responsabilidad alguna con
                                                respecto al contenido, las políticas o prácticas de privacidad de
                                                sitios o servicios de terceros.</p>


                                            <h2>Privacidad del menor</h2>
                                            <p>Nuestro servicio no está dirigido a ningún menor de 18 años (en
                                                adelante, "Menor").</p>
                                            ...
                                            <p>Podemos actualizar nuestra Política de privacidad periódicamente. Le
                                                notificaremos cualquier cambio publicando la nueva Política de
                                                privacidad en esta página.</p>
                                            <p>Le informaremos a través del e-mail y/o de un aviso destacado sobre
                                                ...
                                                privacidad.</p>
                                            <p>Le recomendamos que revise esta Política de privacidad periódicamente
                                            ...
                                            <p>Si tiene alguna pregunta sobre esta Política de privacidad, contacte con
                                                nosotros: </p>
                                            <ul>
                                                <li>Por e-mail: gndectpo@gmail.com</li>
                                                <li>Visitando esta página en nuestro sitio web:
                                                    https://www.tnpgndec.com/privacy</li>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="french">
                                            ...
                                            <p>Date de prise d'effet: October 03, 2018</p>


                                            <p>Training and Placement Cell, GNDEC ("nous", "notre", "nos") exploite le
                                                site web https://www.tnpgndec.com/ et l'application mobile Training And
                                                Placement Cell (ci-après désignés par le terme "Service").</p>

                                            <p>Cette page vous explique nos politiques en matière de collecte,
                                                ...
                                                vous en ce qui concerne ces données. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Politique
                                                    de Confidentialité via Free Privacy Policy</a>.</p>

                                            <p>Nous utilisons vos données pour fournir et améliorer le Service. En
                                                ...
                                                signification que dans nos Conditions Générales.</p>

                                            <h2>Définitions</h2>
                                            <ul>
                                                <li>
                                                    <p><strong>Service</strong></p>
                                                    <p>Par Service on entend le site web https://www.tnpgndec.com/ et
                                                        l'application mobile Training And Placement Cell exploités par
                                                        Training and Placement Cell, GNDEC</p>
                                                </li>
                                                <li>
                                                    <p><strong>Données à caractère personnel</strong></p>
                                                    <p>Données à Caractère Personnel désigne des données concernant un
                                                        ...
                                                        possession ou susceptibles d'entrer en notre possession).</p>
                                                </li>
                                                <li>
                                                    <p><strong>Données d'Utilisation</strong></p>
                                                    <p>Les Données d'Utilisation sont recueillies automatiquement et
                                                        sont générées soit par l'utilisation du Service, soit par
                                                        l'infrastructure du Service proprement dite (par exemple, durée
                                                        de consultation d'une page).</p>
                                                </li>
                                                <li>
                                                    <p><strong>Cookies</strong></p>
                                                    <p>Les cookies sont de petits fichiers enregistrés sur votre
                                                        dispositif (ordinateur ou dispositif mobile).</p>
                                                </li>
                                            </ul>

                                            <h2>Collecte et utilisation des données</h2>
                                            <p>Nous recueillons plusieurs types de données à différentes fins en vue de
                                                vous fournir notre Service et de l'améliorer.</p>

                                            <h3>Types de données recueillies</h3>

                                            <h4>Données à Caractère Personnel</h4>
                                            <p>Lorsque vous utilisez notre Service, il est possible que nous vous
                                            ...
                                            <p>Nous pouvons également recueillir les informations que votre navigateur
                                                ...
                                                d'Utilisation").</p>
                                            <p>Ces Données d'Utilisation peuvent comprendre des informations telles que
                                                ...
                                                dispositifs ainsi que d'autres données de diagnostic.</p>
                                            <p>Lorsque vous accédez au Service au moyen d'un dispositif mobile, ces
                                            ...
                                            <p>Nous avons recours à des cookies et à d'autres technologies de suivi
                                                similaires pour effectuer un suivi des activités effectuées dans notre
                                                Service, et nous conservons certaines informations.</p>
                                            <p>Les cookies sont des fichiers à faible volume de données pouvant
                                                ...
                                                Service.</p>
                                            <p>Vous pouvez demander à votre navigateur de refuser tous les cookies ou
                                                ...
                                                utiliser certains éléments de notre Service.</p>
                                            <p>Exemples de cookies que nous utilisons :</p>
                                            <ul>
                                                <li><strong>Cookies de Session.</strong> Nous utilisons des Cookies de
                                                    Session pour faire fonctionner notre Service.</li>
                                                <li><strong>Cookies de Préférences.</strong> Nous utilisons des Cookies
                                                    de Préférences pour mémoriser vos préférences et vos différents
                                                    paramètres.</li>
                                                <li><strong>Cookies de Sécurité.</strong> Nous utilisons des Cookies de
                                                    Sécurité pour des raisons de sécurité.</li>
                                            </ul>

                                            <h2>Utilisation des données</h2>

                                            <p>Training and Placement Cell, GNDEC utilise les données recueillies à des
                                                fins diverses:</p>
                                            <ul>
                                                <li>Pour fournir et assurer notre Service</li>
                                                <li>Pour vous faire part des changements apportés à notre Service</li>
                                                <li>Pour vous permettre d'utiliser les fonctions interactives de notre
                                                    Service quand vous le souhaitez</li>
                                                <li>Pour assurer l'assistance client</li>
                                                <li>Pour recueillir des données précieuses ou d'analyses qui nous
                                                    permettront d'améliorer notre Service</li>
                                            ...
                                            <p>Les informations vous concernant, notamment vos Données à Caractère
                                                ...
                                                protection des données diffère de celle du territoire où vous résidez.</p>
                                            <p>Si vous résidez hors de/du India et que vous choisissez de nous
                                                ...
                                                nous les y traitons.</p>
                                            <p>En acceptant la présente Politique de Confidentialité puis en soumettant
                                                ces informations, vous consentez à ce transfert.</p>
                                            <p>Training and Placement Cell, GNDEC prendra toutes les mesures
                                                ...
                                                sécurité de vos données et d'autres données personnelles.</p>

                                            <h2>Communication de données</h2>

                                            <h3>Exigences légales</h3>
                                            <p>Training and Placement Cell, GNDEC peut communiquer vos Données à
                                                Caractère Personnel si elle estime de bonne foi que cela est nécessaire
                                                pour:</p>
                                            <ul>
                                                <li>S'acquitter d'une obligation légale</li>
                                                <li>Protéger et défendre les droits ou les biens de Training and
                                                    Placement Cell, GNDEC</li>
                                                <li>Prévenir d'éventuels actes répréhensibles ou enquêter sur de tels
                                                    actes dans le cadre du Service </li>
                                                <li>Assurer la sécurité personnelle des utilisateurs du Service ou du
                                                    public</li>
                                                <li>Se protéger contre la responsabilité civile</li>
                                            </ul>

                                            <h2>Sécurité des données</h2>
                                            <p>La sécurité de vos données nous tient à cœur. Toutefois, n'oubliez pas
                                            ...
                                            <p>Nous pouvons faire appel à des sociétés tierces et à des tierces
                                                ...
                                                est utilisé.</p>
                                            <p>Ces tiers n'ont accès à vos Données à Caractère Personnel que pour
                                                effectuer ces tâches en notre nom et il leur est interdit de les
                                                communiquer ou de les utiliser à quelle qu'autre fin. </p>

                                            <h3>Analyses</h3>
                                            <p>Nous pouvons faire appel à des Prestataires de Services tiers pour
                                                surveiller et analyser l'utilisation de notre Service.</p>
                                            <ul>
                                                <li>
                                                    <p><strong>Google Analytics</strong></p>
                                                    <p>Google Analytics est un service d'analyse web proposé par Google
                                                    ...
                                                    <p>Pour plus de précisions sur les pratiques de confidentialité de
                                                        Google, merci de consulter la page web Protection de la vie
                                                        privée et conditions de Google: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                                                </li>
                                            </ul>


                                            <h2>Liens pointant vers d'autres sites</h2>
                                            <p>Il se peut que notre Service contienne des liens pointant vers d'autres
                                            ...
                                            <p>Nous n'avons aucun contrôle sur le contenu, les politiques ou pratiques
                                                de confidentialité des sites ou services de tiers et déclinons toute
                                                responsabilité en ce qui les concerne.</p>


                                            <h2>Vie privée des enfants</h2>
                                            <p>Notre Service ne s'adresse pas aux personnes de moins de 18 ans
                                                ("Enfants").</p>
                                            <p>Nous ne recueillons pas sciemment de données personnelles nominatives
                                                ...
                                                nécessaire pour supprimer ces informations de nos serveurs.</p>


                                            <h2>Modifications de la présente Politique de Confidentialité</h2>
                                            <p>Nous nous réservons le droit d'actualiser notre Politique de
                                                ...
                                                cette page.</p>
                                            <p>Avant que la modification ne prenne effet, nous vous en informerons par
                                            ...
                                            <p>Nous vous conseillons de consulter la présente Politique de
                                            ...
                                            <ul>
                                                <li>Par courrier électronique: gndectpo@gmail.com</li>
                                                <li>En consultant cette page sur notre site web:
                                                    https://www.tnpgndec.com/privacy</li>
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="german">
                                            ...
                                            <p>Datum des Inkrafttretens: October 03, 2018</p>


                                            <p>Training and Placement Cell, GNDEC ("wir", "uns", "unser" usw.) betreibt
                                                die Website https://www.tnpgndec.com/ und die mobile App Training And
                                                Placement Cell (nachstehend als "Dienst" bezeichnet).</p>

                                            <p>Diese Seite enthält Informationen zu der Art und Weise, auf welche wir
                                                ...
                                                mit diesen Daten zur Verfügung stehen. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Datenschutz-Richtlinie
                                                    via Free Privacy Policy</a>.</p>

                                            <p>Wir nutzen Ihre Daten zur Bereitstellung und Verbesserung unseres
                                                ...
                                                (Terms and Conditions) zugewiesen wurde.</p>

                                            <h2>Begriffsbestimmungen</h2>
                                            <ul>
                                                <li>
                                                    <p><strong>Dienst</strong></p>
                                                    <p>Der Dienst ist die von dem Training and Placement Cell, GNDEC
                                                        betriebene Website https://www.tnpgndec.com/ und mobile App
                                                        Training And Placement Cell.</p>
                                                </li>
                                                <li>
                                                    <p><strong>Personenbezogene Daten</strong></p>
                                                    <p>Personenbezogene Daten sind Daten, die sich auf eine lebende
                                                        ...
                                                        in unseren Besitz gelangen werden) identifizierbar ist.</p>
                                                </li>
                                                <li>
                                                    <p><strong>Nutzungsdaten</strong></p>
                                                    <p>Nutzungsdaten sind Daten, die automatisch im Rahmen der Nutzung
                                                ...
                                                <li>
                                                    <p><strong>Cookies</strong></p>
                                                    <p>Cookies sind kleine Dateien, die auf Ihrem Gerät (Computer oder
                                                        mobiles Endgerät) gespeichert werden.</p>
                                                </li>
                                            </ul>

                                            <h2>Erfassung und Nutzung von Daten</h2>
                                            <p>Wir erfassen verschiedene Arten von Daten für eine Reihe von Zwecken, um
                                                den Dienst, den wir Ihnen zur Verfügung stellen, zu verbessern.</p>

                                            <h3>Arten der erfassten Daten</h3>

                                            <h4>Personenbezogene Daten</h4>
                                            <p>Im Rahmen der Nutzung unseres Dienstes bitten wir Sie gegebenenfalls um
                                                ...
                                                beispielsweise folgende Daten (sind jedoch nicht auf diese beschränkt):</p>

                                            <ul>
                                                <li>E-Mail-Adresse</li>
                                                <li>Vorname und Nachname</li>
                                                <li>Telefonnummer</li>
                                                <li>Adresse, Staat, Provinz, Postleitzahl, Ort</li>
                                                <li>Cookies und Nutzungsdaten</li>
                                            </ul>

                                            <h4>Nutzungsdaten</h4>

                                            <p>Wie können außerdem solche Daten erfassen, die Ihr Browser jedes Mal
                                                ...
                                                ("Nutzungsdaten").</p>
                                            <p>Diese Nutzungsdaten umfassen gegebenenfalls die
                                                ...
                                                Geräteidentifikationsmerkmale und weitere Diagnostikdaten.</p>
                                            <p>Wenn Sie auf unseren Dienst mithilfe eines mobilen Endgeräts zugreifen,
                                            ...
                                            <p>Wir setzen Cookies und ähnliche Tracking-Technologien zur Überwachung
                                                der Aktivität innerhalb unseres Dienstes ein und speichern in diesem
                                                Zusammenhang bestimmte Daten.</p>
                                            <p>Cookies sind Dateien mit einem geringen Datenumfang, wie zum Beispiel
                                                ...
                                                von Daten sowie der Verbesserung und Analyse unseres Dienstes.</p>
                                            <p>Sie können in den Einstellungen Ihres Browsers bestimmen, ob Sie alle
                                                ...
                                                gegebenenfalls Teile unseres Dienstes nicht in Anspruch nehmen.</p>
                                            <p>Beispiele für von uns eingesetzte Cookies:</p>
                                            <ul>
                                                <li><strong>Sitzungs-Cookies.</strong> Wir setzen Sitzungs-Cookies für
                                                    den Betrieb unseres Dienstes ein.</li>
                                                <li><strong>Präferenz-Cookies.</strong> Wir setzen Präferenz-Cookies
                                                    ein, um Ihre Präferenzen und verschiedenen Einstellungen zu
                                                    speichern.</li>
                                                <li><strong>Sicherheits-Cookies.</strong> Wir setzen
                                                    Sicherheits-Cookies für Sicherheitszwecke ein.</li>
                                            </ul>

                                            <h2>Datennutzung</h2>
                                            <p>Wir bei Training and Placement Cell, GNDEC nutzen die erfassten Daten
                                                für verschiedene Zwecke, beispielsweise um:</p>
                                            <ul>
                                                <li>Ihnen unseren Dienst zur Verfügung zu stellen und diesen aufrecht
                                                    zu erhalten;</li>
                                                <li>Ihnen Änderungen in Bezug auf unseren Dienst mitzuteilen;</li>
                                                <li>es Ihnen auf Wunsch zu ermöglichen, an den interaktiven Teilen
                                                    unseres Dienstes teilzunehmen;</li>
                                                <li>Kundendienstleistungen zur Verfügung zu stellen;</li>
                                                <li>Analysedaten und sonstige wertvolle Daten zu erfassen, damit wir
                                                    unseren Dienst verbessern können;</li>
                                            ...
                                            <p>Ihre Daten, einschließlich personenbezogener Daten, können auf Computer
                                                ...
                                                Rechtsordnung unterscheiden.</p>
                                            <p>Falls Sie sich außerhalb von India befinden und sich dazu entscheiden,
                                                ...
                                                übertragen und diese dort verarbeiten.</p>
                                            <p>Ihre Zustimmung zu dieser Datenschutz-Richtlinie und eine nachfolgende
                                                Übermittlung von Daten Ihrerseits stellt eine Einverständniserklärung
                                                Ihrerseits zu der genannten Übertragung dar.</p>
                                            <p>Training and Placement Cell, GNDEC wird alle im zumutbaren Rahmen
                                                ...
                                                sonstigen personenbezogenen Informationen vorliegen.</p>

                                            <h2>Offenlegung von Daten</h2>

                                            <h3>Gesetzliche Anforderungen</h3>
                                            <p>Training and Placement Cell, GNDEC kann Ihre personenbezogenen Daten
                                            ...
                                            <ul>
                                                ...
                                                <li>zum Schutz und zur Verteidigung der Rechte oder des Eigentums von
                                                    Training and Placement Cell, GNDEC</li>
                                                <li>zur Vermeidung oder Untersuchung möglicher Fehlverhaltensweisen in
                                                    Bezug auf den Dienst </li>
                                                <li>zum Schutz der persönlichen Sicherheit der Nutzer des Dienstes oder
                                                    der Öffentlichkeit</li>
                                                <li>zur Vermeidung von Haftungsansprüchen</li>
                                            </ul>

                                            <h2>Datensicherheit</h2>
                                            <p>Die Sicherheit Ihrer Daten ist uns wichtig. Bitte vergessen Sie jedoch
                                                ...
                                                Sicherheit nicht garantieren.</p>

                                            <h2>Leistungsanbieter</h2>
                                            <p>Wir beauftragen gegebenenfalls dritte Unternehmen und Einzelpersonen
                                                ...
                                                die unser Dienst in Anspruch genommen wird.</p>
                                            <p>Diese Dritten können auf Ihre personenbezogenen Daten nur in dem Umfang
                                                ...
                                                offenlegen oder nutzen.</p>

                                            <h3>Analytik</h3>
                                            <p>Wir beauftragen gegebenenfalls dritte Leistungsanbieter mit der
                                                Überwachung und Analyse der Nutzung unseres Dienstes.</p>
                                            <ul>
                                                <li>
                                                    <p><strong>Google Analytics</strong></p>
                                                    <p>Google Analytics ist ein von Google angebotener
                                                        ...
                                                        Werbenetzwerks nutzen.</p>
                                                    <p>Weitere Informationen zu den Datenschutzmaßnahmen von Google
                                                        können Sie auf Googles Webseite zu seinen
                                                        Datenschutzbestimmungen (Privacy Terms) einsehen: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                                                </li>
                                            </ul>


                                            <h2>Links zu anderen Websites</h2>
                                            <p>Unser Dienst kann Links zu anderen Websites enthalten, die nicht von uns
                                                ...
                                                aller von Ihnen besuchten Websites durchzulesen.</p>
                                            <p>Wir haben keine Kontrolle über die Inhalte, Datenschutzvorschriften und
                                                -praktiken dritter Websites oder Dienste und übernehmen in diesem
                                                Zusammenhang keine Haftung.</p>


                                            <h2>Privatsphäre Minderjähriger</h2>
                                            <p>Unser Dienst richtet sich nicht an Personen, die das 18. Lebensjahr noch
                                                nicht vollendet haben ("minderjährige Personen").</p>
                                            <p>Wir erfassen wissentlich keine persönlich identifizierbaren Daten zu
                                                ...
                                                Daten von unseren Servern um.</p>


                                            <h2>Änderungen dieser Datenschutz-Richtlinie</h2>
                                            <p>Wir können unsere Datenschutz-Richtlinie von Zeit zu Zeit aktualisieren.
                                                Jegliche solcher Änderungen teilen wir Ihnen mit, indem wir die
                                                aktualisierte Fassung auf dieser Seite veröffentlichen.</p>
                                            <p>Wir werden Sie vor dem Inkrafttreten der betreffenden Änderung per
                                                ...
                                                Beginn dieser Datenschutz-Richtlinie aktualisieren.</p>
                                            <p>Wir empfehlen Ihnen, diese Datenschutz-Richtlinie regelmäßig auf
                                                Änderungen hin durchzusehen. Änderungen dieser Datenschutz-Richtlinie
                                                werden im Zeitpunkt ihrer Veröffentlichung auf dieser Seite wirksam.</p>


                                            <h2>Kontaktaufnahme</h2>
                                            <p>Falls Sie Fragen zu dieser Datenschutz-Richtlinie haben, können Sie wie
                                                folgt Kontakt zu uns aufnehmen:</p>
                                            <ul>
                                                <li>Per E-Mail: gndectpo@gmail.com</li>
                                                <li>Durch Besuch der folgenden Seite unserer Website:
                                                    https://www.tnpgndec.com/privacy</li>
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="italian">
                                            ...
                                            <p>Data di entrata in vigore: October 03, 2018</p>


                                            <p>Training and Placement Cell, GNDEC ("noi" o "nostro") gestisce il sito
                                                web https://www.tnpgndec.com/ e l'applicazione Training And Placement
                                                Cell per dispositivi mobili (in appresso il "Servizio").</p>

                                            <p>Questa pagina vi informa delle nostre politiche riguardanti la raccolta,
                                                l'uso e la divulgazione dei dati personali quando usate il nostro
                                                Servizio e le scelte che avete associato a quei dati. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Informativa
                                                    sulla Privacy via Free Privacy Policy</a>.</p>

                                            <p>Utilizziamo i vostri dati per fornire e migliorare il Servizio.
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <p>Servizio significa il https://www.tnpgndec.com/ sito web e
                                                        l'applicazione per dispositivi mobili Training And Placement
                                                        Cell gestiti da Training and Placement Cell, GNDEC</p>
                                                </li>
                                                <li>
                                                    <p><strong>Dati personali</strong></p>
                                                    <p>I Dati personali sono i dati di un individuo vivente che può
                                                ...
                                                <li>
                                                    ...
                                                    <p>I dati di utilizzo sono i dati raccolti automaticamente generati
                                                        dall'utilizzo del Servizio o dall'infrastruttura del Servizio
                                                        stesso (ad esempio, la durata della visita di una pagina).</p>
                                                </li>
                                                <li>
                                                    <p><strong>Cookies</strong></p>
                                                    <p>I cookie sono piccoli file memorizzati sul vostro dispositivo
                                                        (computer o dispositivo mobile).</p>
                                                </li>
                                            </ul>

                                            <h2>Raccolta e uso delle informazioni</h2>
                                            <p>Raccogliamo diversi tipi di informazioni per vari scopi, per fornire e
                                                migliorare il nostro servizio.</p>

                                            <h3>Tipologie di Dati raccolti</h3>

                                            <h4>Dati personali</h4>
                                            <p>Durante l'utilizzo del nostro Servizio, potremmo chiedervi di fornirci
                                            ...
                                            <ul>
                                                ...
                                                <li>AIndirizzo, stato, provincia, codice postale, città</li>
                                                <li>Cookie e dati di utilizzo</li>
                                            </ul>

                                            <h4>Dati di utilizzo</h4>

                                            <p>Possiamo anche raccogliere informazioni che il browser invia ogni volta
                                                che si visita il nostro Servizio o quando si accede al servizio o
                                                tramite un dispositivo mobile ("Dati di utilizzo").</p>
                                            <p>Questi Dati di utilizzo possono includere informazioni quali l'indirizzo
                                                ...
                                                pagine, identificatore unico del dispositivo e altri dati diagnostici.</p>
                                            <p>Quando si accede al Servizio attraverso un dispositivo mobile, questi
                                                ...
                                                identificatori di dispositivo univoci e altri dati diagnostici.</p>

                                            <h4>Tracciamento; dati dei cookie</h4>
                                            <p>Utilizziamo cookie e tecnologie di tracciamento simili per tracciare
                                                l'attività sul nostro Servizio e conservare determinate informazioni.</p>
                                            <p>I cookie sono file con una piccola quantità di dati che possono
                                                ...
                                                migliorare e analizzare il nostro Servizio.</p>
                                            <p>Potete chiedere al vostro browser di rifiutare tutti i cookie o di
                                            ...
                                            <ul>
                                                <li><strong>Cookie di sessione.</strong> Utilizziamo i cookie di
                                                    sessione per gestire il nostro servizio.</li>
                                                <li><strong>Cookie di preferenza.</strong> Utilizziamo i cookie di
                                                    preferenza per ricordare le vostre preferenze e varie impostazioni.</li>
                                                <li><strong>Cookie di sicurezza.</strong> Utilizziamo i cookie di
                                                    sicurezza per motivi di sicurezza.</li>
                                            </ul>

                                            <h2>Uso dei dati</h2>
                                            <p>Training and Placement Cell, GNDEC utilizza i dati raccolti per vari
                                                scopi:</p>
                                            <ul>
                                                <li>Per fornire e mantenere il nostro Servizio</li>
                                                <li>Per comunicare agli utenti variazioni apportate al servizio che
                                                    offriamo</li>
                                                <li>Per permettere agli utenti di fruire, a propria discrezione, di
                                                    funzioni interattive del nostro servizio</li>
                                                <li>Per fornire un servizio ai clienti</li>
                                                <li>Per raccogliere analisi o informazioni preziose in modo da poter
                                                    migliorare il nostro Servizio</li>
                                            ...
                                            <p>Le vostre informazioni, compresi i Dati personali, possono essere
                                            ...
                                            <p>Se ci si trova al di fuori di India e si sceglie di fornire informazioni
                                                a noi, si ricorda che trasferiamo i dati, compresi i dati personali, in
                                                India e li elaboriamo lì.</p>
                                            <p>Il vostro consenso alla presente Informativa sulla privacy seguito
                                                dall'invio di tali informazioni rappresenta il vostro consenso al
                                                trasferimento.</p>
                                            <p>Training and Placement Cell, GNDEC adotterà tutte le misure
                                                ...
                                                controlli adeguati dei vostri dati e altre informazioni personali.</p>

                                            <h2>Divulgazione di dati</h2>

                                            <h3>Prescrizioni di legge</h3>
                                            <p>Training and Placement Cell, GNDEC può divulgare i vostri Dati personali
                                                in buona fede, ritenendo che tale azione sia necessaria per:</p>
                                            <ul>
                                                <li>Rispettare un obbligo legale</li>
                                                <li>Proteggere e difendere i diritti o la proprietà di Training and
                                                    Placement Cell, GNDEC</li>
                                                <li>Prevenire o investigare possibili illeciti in relazione al Servizio</li>
                                                <li>Proteggere la sicurezza personale degli utenti del Servizio o del
                                                    pubblico</li>
                                                <li>Proteggere contro la responsabilità legale</li>
                                            </ul>

                                            <h2>Sicurezza dei dati</h2>
                                            <p>La sicurezza dei vostri dati è importante per noi, ma ricordate che
                                            ...
                                            <p>Potremmo impiegare società e individui di terze parti per facilitare il
                                                ...
                                                ad analizzare come viene utilizzato il nostro Servizio.</p>
                                            <p>Le terze parti hanno accesso ai vostri Dati personali solo per eseguire
                                                queste attività per nostro conto e sono obbligate a non rivelarle o
                                                utilizzarle per altri scopi.</p>

                                            <h3>Statistiche</h3>
                                            <p>Potremmo utilizzare i Fornitori di servizi di terze parti per monitorare
                                                e analizzare l'utilizzo del nostro servizio.</p>
                                            <ul>
                                                <li>
                                                    <p><strong>Google Analytics</strong></p>
                                                    <p>Google Analytics è un servizio di analisi web offerto da Google
                                                        ...
                                                        rete pubblicitaria.</p>
                                                    <p>Per ulteriori informazioni sulle prassi relative alla privacy di
                                            ...
                                            <p>OIl nostro servizio può contenere collegamenti ad altri siti non gestiti
                                                ...
                                                l'Informativa sulla privacy di ogni sito che visiti.</p>
                                            <p>Non abbiamo alcun controllo e non ci assumiamo alcuna responsabilità per
                                                il contenuto, le politiche sulla privacy o le pratiche di qualsiasi
                                                sito o servizio di terzi.</p>


                                            <h2>Privacy dei minori</h2>
                                            <p>Il nostro servizio non si rivolge a minori di 18 anni ("Bambini").</p>
                                            <p>Non raccogliamo consapevolmente informazioni personali relative a utenti
                                            ...
                                            <p>Potremmo aggiornare periodicamente la nostra Informativa sulla privacy.
                                                Ti informeremo di eventuali modifiche pubblicando la nuova Informativa
                                                sulla privacy in questa pagina.</p>
                                            <p>Vi informeremo via e-mail e / o un avviso di rilievo sul nostro
                                                ...
                                                privacy.</p>
                                            <p>Si consiglia di rivedere periodicamente la presente Informativa sulla
                                            ...
                                            <h2>Contattaci</h2>
                                            <p>In caso di domande sulla presente Informativa sulla privacy, si prega di
                                                contattarci:</p>
                                            <ul>
                                                <li>Tramite e-mail: gndectpo@gmail.com</li>
                                                <li>Visitando questa pagina sul nostro sito web:
                                                    https://www.tnpgndec.com/privacy</li>

                                            </ul>
                                        </div>
                                        <div role="tabpanel" class="tab-pane " id="dutch">
                                            <h1>Privacybeleid</h1>


                                            <p>Ingangsdatum: October 03, 2018</p>


                                            <p>Training and Placement Cell, GNDEC ("ons", "wij" of "onze") beheert de
                                                https://www.tnpgndec.com/ website en de Training And Placement Cell
                                                mobiele App ("hierna genoemd Dienst").</p>

                                            <p>Deze pagina bevat informatie over ons beleid met betrekking tot de
                                                ...
                                                tot die gegevens. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Privacybeleid
                                                    via Free Privacy Policy</a>.</p>

                                            <p>Wij gebruiken uw gegevens om de Dienst te leveren en te verbeteren.
                                            ...
                                            <ul>
                                                <li>
                                                    <p><strong>Dienst</strong></p>
                                                    <p>Onder dienst verstaan wij de https://www.tnpgndec.com/ website
                                                        en de Training And Placement Cell mobiele App beheerd door
                                                        Training and Placement Cell, GNDEC</p>
                                                </li>
                                                <li>
                                                    <p><strong>Gebruiksgegevens</strong></p>
                                                    <p>Onder gebruiksgegevens verstaan wij automatisch verzamelde
                                                ...
                                                <li>
                                                    <p><strong>Cookies</strong></p>
                                                    <p>Cookies zijn informatiebestandjes die worden opgeslagen op uw
                                                        apparaat (computer of mobiele apparaat).</p>
                                                </li>
                                            </ul>

                                            <h2>Gegevensverzameling en gebruik</h2>
                                            <p>Wij verzamelen verschillende soorten gegevens voor uiteenlopende
                                            ...
                                            <p>Wanneer u onze Dienst gebruikt, kunnen wij u vragen ons bepaalde
                                                ...
                                                omvatten maar is niet beperkt tot:</p>
                                            ...
                                            <p>Wij kunnen ook gegevens verzamelen die uw browser verstuurt wanneer u
                                                onze Dienst bezoekt of wanneer u toegang krijgt tot de Dienst met of
                                                via een mobiele apparaat ("Gebruiksgegevens").</p>
                                            <p>Deze Gebruiksgegevens kunnen informatie bevatten zoals het Internet
                                                ...
                                                die pagina's, unieke apparaat-ID en andere diagnostische gegevens.</p>
                                            <p>Wanneer u toegang krijgt tot de Dienst met een mobiel apparaat kunnen
                                            ...
                                            <p>Wij gebruiken cookies en soortgelijke volgtechnologieën om de activiteit
                                                op onze Dienst te volgen en we bewaren bepaalde informatie.</p>
                                            <p>Cookies zijn bestanden met een kleine hoeveelheid gegevens die een
                                                ...
                                                te analyseren.</p>
                                            <p>U kunt uw browser instellen om alle cookies te weigeren of om aan te
                                            ...
                                            <ul>
                                                <li><strong>Sessiecookies.</strong> Wij gebruiken Sessiecookies om onze
                                                    Dienst te beheren.</li>
                                                <li><strong>Voorkeurcookies.</strong> Wij gebruiken Voorkeurcookies om
                                                    uw voorkeuren en uiteenlopende instellingen bij te houden.</li>
                                                <li><strong>Veiligheidscookies.</strong> Wij gebruiken
                                                    Veiligheidscookies voor veiligheidsdoeleinden.</li>
                                            </ul>

                                            <h2>Gebruik van gegevens</h2>
                                            <p>Training and Placement Cell, GNDEC gebruikt de verzamelde gegevens voor
                                                uiteenlopende doeleinden:</p>
                                            <ul>
                                                <li>Om onze Dienst te leveren en te onderhouden</li>
                                                <li>Om u wijzigingen in onze Dienst te melden</li>
                                                <li>Om u de mogelijkheid te bieden om, indien gewenst, deel te nemen
                                                    aan de interactieve functies van onze Dienst</li>
                                                <li>Om onze klanten steun te verlenen</li>
                                                <li>Om analyse- of waardevolle gegevens te verzamelen die we kunnen
                                                    toepassen om onze Dienst te verbeteren</li>
                                                <li>Om toezicht te houden op het gebruik van onze Dienst</li>
                                                <li>Om technische problemen te detecteren, te voorkomen en te
                                                    behandelen</li>
                                                <li>Om u nieuws, speciale aanbiedingen en algemene informatie te bieden
                                                    ...
                                                    niet wenst te ontvangen.</li>
                                            </ul>

                                            <h2>Overdracht van gegevens</h2>
                                            <p>Uw gegevens, inclusief Persoonsgegevens, kunnen worden overgedragen naar
                                            ...
                                            <p>Let erop dat, als u zich buiten India bevindt en u ons gegevens
                                                verstrekt, wij deze gegevens, inclusief Persoonsgegevens, overdragen
                                                naar India en ze daar verwerken.</p>
                                            <p>Uw instemming met dit Privacybeleid gevolgd door uw indiening van
                                                dergelijke gegevens geven aan dat u akkoord gaat met die overdracht.</p>
                                            <p>Training and Placement Cell, GNDEC zal alle redelijkerwijs noodzakelijke
                                                ...
                                                veiligheid van uw gegevens en andere persoonsgegevens.</p>

                                            <h2>Openbaarmaking van gegevens</h2>

                                            <h3>Wettelijke vereisten</h3>
                                            <p>Training and Placement Cell, GNDEC kan uw Persoonsgegevens openbaar
                                                maken als het te goeder trouw de mening is toegedaan dat een dergelijke
                                                handeling noodzakelijk is:</p>
                                            <ul>
                                                <li>Om te voldoen aan een wettelijke verplichting</li>
                                                <li>Om de rechten en eigendom van Training and Placement Cell, GNDEC te
                                                    beschermen en te verdedigen</li>
                                                <li>Om mogelijke misstanden te voorkomen of te onderzoeken in verband
                                                    met de Dienst</li>
                                                <li>Om de persoonlijke veiligheid van gebruikers van de Dienst of het
                                                    publiek te beschermen</li>
                                                <li>Als bescherming tegen juridische aansprakelijkheid</li>
                                            </ul>

                                            <h2>Veiligheid van gegevens</h2>
                                            <p>De veiligheid van uw gegevens is belangrijk voor ons, maar vergeet niet
                                            ...
                                            <p>Wij kunnen externe bedrijven en personen aanstellen om onze Dienst
                                                ...
                                                te helpen bij de analyse van hoe onze Dienst wordt gebruikt.</p>
                                            <p>Deze externe partijen hebben enkel toegang tot uw Persoonsgegevens om
                                                deze taken uit te voeren in onze naam en zij mogen deze niet openbaar
                                                maken aan anderen of ze gebruiken voor andere doeleinden.</p>

                                            <h3>Analytics</h3>
                                            <p>Wij kunnen beroep doen op externe Dienstverleners om het gebruik van
                                                onze Dienst te volgen en te analyseren.</p>
                                            <ul>
                                                <li>
                                                    <p><strong>Google Analytics</strong></p>
                                                    <p>Google Analytics is een webanalyse-service van Google die het
                                                    ...
                                                    <p>Voor meer informatie over de privacypraktijken van Google
                                                        verwijzen wij u naar de internetpagina van Google Privacy en
                                                        voorwaarden: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                                                </li>
                                            </ul>


                                            <h2>Links naar andere sites</h2>
                                            <p>Onze Dienst kan links bevatten naar andere sites die niet door ons
                                                ...
                                                Privacybeleid te verifiëren van elke site die u bezoekt.</p>
                                            <p>Wij hebben geen controle over en aanvaarden geen aansprakelijkheid met
                                                betrekking tot de inhoud, het privacybeleid of de privacypraktijken van
                                                de sites of diensten van een externe partij.</p>


                                            <h2>Privacy van kinderen</h2>
                                            <p>Onze dienst richt zich niet op personen die jonger zijn dan 18
                                                ("Kinderen").</p>
                                            <p>Wij verzamelen nooit bewust persoonlijk identificeerbare informatie van
                                                ...
                                                informatie te verwijderen van onze servers.</p>


                                            <h2>Wijzigingen aan dit Privacybeleid</h2>
                                            <p>Wij kunnen ons Privacybeleid op gezette tijden bijwerken. Wij zullen u
                                                op de hoogte brengen van eventuele wijzigingen door het nieuwe
                                                Privacybeleid te publiceren op deze pagina.</p>
                                            <p>Wij zullen u op de hoogte brengen via e-mail en/of een duidelijke
                                                ...
                                                Privacybeleid.</p>
                                            <p>Wij raden u aan dit Privacybeleid regelmatig te controleren op eventuele
                                                wijzigingen. Wijzigingen aan dit Privacybeleid gaan van kracht op het
                                                moment dat ze worden gepubliceerd op deze pagina.</p>


                                            <h2>Contact opnemen</h2>
                                            <p>Als u vragen hebt over dit Privacybeleid kunt u contact opnemen met ons:</p>
                                            <ul>
                                                <li>Via email: gndectpo@gmail.com</li>
                                                <li>Via deze pagina op onze website: https://www.tnpgndec.com/privacy</li>
...
<style scoped>
    ...
    .languages .nav-tabs li {
        font-size: 14px;
    }

    .languages .nav-tabs li a {
        padding: 10px 15px;
        border: 0;
        border-radius: 0;
    }
