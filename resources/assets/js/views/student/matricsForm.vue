                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      v-else
                    />
                    <span class="small text-danger pull-right">
                      {{errors.first('max marks')}}
                      <span
                        id="percent"
                ...
                <div class="col-md-4">
                  <div class="form-group files">
                    ...
                    <small class="form-text text-primary text-uppercase">
                      ...
                      <span
                        class="small text-danger pull-right"
  ...
  methods: {
    ...
    percentCalculate() {
      if (this.student.marks_type == "CGPA") {
        if (
          this.student.obtained_marks != undefined &&
          (this.student.max_marks != undefined || this.student.max_marks != "")
        ) {
          this.percent = parseFloat(this.student.obtained_marks * 9.5).toFixed(
            3
          );
        } else {
          this.percent = 0;
        ...
        if (
          ...
          this.percent = parseFloat(
            (this.student.obtained_marks / this.student.max_marks) * 100
          ).toFixed(3);
        } else {
          this.percent = 0;
        }
    ...
    submit() {
      ...
      this.student.institute = this.$parent.titleCase(this.student.institute);
      ...
      axios
        .post(storeStudentMeURL + this.student.id, formData, {
          ...
          axios
            ...
            .then(statusresponse => {
              if (statusresponse.status == 200) {
                toastr["success"]("Metric Marks Added!!");
                this.$parent.step = 5;
              }
            })
            .catch(errors => {
