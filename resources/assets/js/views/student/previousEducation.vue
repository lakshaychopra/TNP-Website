                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                      ...
                      <span> *Fill NA if not appeared*</span>
...
<script>
  ...
  export default {
    ...
    methods: { 
     ...
     // },
       percentCalculate1() {
        if (this.student.XII_max_marks != undefined && this.student.XII_obtained_marks != undefined ) {
      ...
      percentCalculate2(){
        if(this.student.diploma_obtained_marks != undefined && this.student.diploma_max_marks != undefined && this.student.diploma_obtained_marks<=this.student.diploma_max_marks){
