  ...
  methods: {
    ...
    gap_calculator() {
      ...
      if (
        ...
        if (
          document.getElementById("XII_year").value.length == 4 ||
          document.getElementById("diploma_year").value.length == 4
        ) {
          if (
            this.student.education == "XII" ||
            this.student.education == "BOTH"
          ) {
            // console.log('1111');
