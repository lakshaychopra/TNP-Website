              ...
              <form method="post" @submit.prevent="validateForm">
                <div id="dynamic_container">
                  ...
                  <div>
                    ...
                    <label>Company</label>
                    <select
                      class="mdb-select colorful-select dropdown-primary md-form form-control"
                      v-model="company_name"
                    >
                      <option value disabled selected>Choose Company</option>
                      <option
                        v-for="company in companies"
                        v-bind:value="company.company_name"
                  ...
                  >
                    ...
                    >B.Tech Electronics And Communication Engineering</option>
                    ...
                    <option
                      value="M.Tech Computer Science And Engineering"
                    >M.Tech Computer Science And Engineering</option>
                    <option
                      value="M.Tech Geo-Technical Engineering"
                    >M.Tech Geo-Technical Engineering</option>
                    <option
                      value="M.Tech Environmental Science And Engineering"
                    >M.Tech Environmental Science And Engineering</option>
                    <option
                      value="M.Tech Electronics And Communication Engineering"
                    >M.Tech Electronics And Communication Engineering</option>
                    <option value="M.Tech Electrical Engineering">M.Tech Electrical Engineering</option>
                    <option
                      value="M.Tech Soil Mechanics And Foundation Engineering"
                    >M.Tech Soil Mechanics And Foundation Engineering</option>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      axios
        .post("api/company_registration", formData)
        .then(response => {
...
input[type="text,password"] select.form-control {
...
input[type="text,password"]:disabled {
