    ...
    editor.addButton('placementPost', {
        ...
        onclick: function() {
            ...
            editor.windowManager.open({
                ...
                body: [
                    { type: 'textbox', name: 'dtype', label: 'Drive Type (Example - Campus Placement)' },
                    ...
                    { type: 'textbox', name: 'branch', label: 'Branchs (Example - B.Tech(CSE/IT) and MCA)' },
