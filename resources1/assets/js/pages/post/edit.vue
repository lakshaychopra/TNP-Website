<template>
    ...
    <input type="hidden" name="_token" :value="csrf">
      ...
      <vue-html5-editor class="form-control" :content="rec.body" :height="300" :auto-height="true"  @change="updateData">{{rec.body}}</vue-html5-editor>
      </el-form-item>
      ...
      <el-form-item label="Image">
       <div class="form-group files">
         <div v-if="rec.image !=null">
       <img v-if="image_change == true" class="img-responsive" :src="rec.image" alt="Image">
       <img v-else class="img-responsive" :src="'/images/posts/images/'+rec.image" alt="Image">
         </div>
...
export default {
  ...
  methods: {
      ...
      //  this.$refs.post.file.files[0] = rec.image;
      },
    ...
    handleChange(e) {
      ...
      this.rec.image = URL.createObjectURL(file);
      console.log(this.rec.image);
      image_change = true;  
},
